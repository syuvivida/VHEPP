...
void jetECalHcal(string inputDir, float radius=0.4){
  ...
  TH2F* h_jeratio_phoratio = new TH2F("h_jeratio_phoratio","",50,0,1,50,0,1.5);
  ...
  string inputFile = inputDir + "/radius" + Form("%0.1f",radius)+ "_ECALHCAL.root";
